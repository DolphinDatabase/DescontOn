...
<img src="https://github.com/DolphinDatabase/DescontOn/blob/9b279d7bfa021281bd1e0d11e4493e65d3021a43/Documenta%C3%A7%C3%A3o/SPRINT3/Imagens/CANVAS.png">

## Documentação
  
  <details><summary>Modelo Conceitual</summary>
  
  <img src="https://github.com/DolphinDatabase/DescontOn/blob/ebf0051ea024984c038dce84c2d153560b996701/Documenta%C3%A7%C3%A3o/SPRINT3/Imagens/Modelo_Conceitual.jpeg">
 
  </details>
  
  <details><summary>Modelo Relacional</summary>
  
  <img src="https://github.com/DolphinDatabase/DescontOn/blob/ebf0051ea024984c038dce84c2d153560b996701/Documenta%C3%A7%C3%A3o/SPRINT3/Imagens/Modelo_Relacional.jpeg">
...
Para acessar o vídeo[^1] de demonstração da aplicação em uso, clique [aqui](https://www.youtube.com/watch?v=NhDe9-Z_dvk):

[<img src="https://github.com/DolphinDatabase/DescontOn/blob/47f0f23ee3d7710b472fc1ff26d06da50237681e/Imagens/imagem_2022-04-15_155641874.png" width="40%">](https://www.youtube.com/watch?v=NhDe9-Z_dvk "DescontOn vídeo Demonstração")
...
<details><summary>Story 16 - Verificar Promoções</summary>
...
<details><summary>Story 17 - Cadastrar Produtos em (N) Promoções</summary>
  
| Como | Eu quero | Para que |
| ------- | ------- | ------- |
| Administrador de um E-commerce. | Cadastrar o mesmo produto em uma ou mais promoções. | Expanda o alcance das vendas. |
  
</details>


<details><summary>Story 18 - Criar Novas Condições/Ações de Promoções</summary>
  
| Como | Eu quero | Para que |
| ------- | ------- | ------- |
| Administrador de um E-commerce. | Ter mais condições e ações no cadastro de promoções. | Haja uma abrangência maior de tipos de promoções. |
  
</details>


<details><summary>Story 19 - Exibir o Desconto e Promoção de Cada Produto na Sacola de Compras</summary>
  
| Como | Eu quero | Para que |
| ------- | ------- | ------- |
| Administrador de um E-commerce. | Que na tela da sacola, exiba valores de desconto e promoção de cada produto. | O usuário possa visualizar com mais clareza os valores dos produtos com os descontos e promoções aplicadas. |
  
</details>

<details><summary>Story 20 - Criar Mecânicas com Modelos Lógicos</summary>
  
| Como | Eu quero | Para que |
| ------- | ------- | ------- |
| Administrador de um E-commerce. | Criar mecânicas de promoção com operações lógicas que trabalham sobre valores booleanos (“e”, “ou”). | Seja aumentada as possibilidades de criar promoções. |
