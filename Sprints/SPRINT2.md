...
| Como | Eu quero | Para que |
| ------- | ------- | ------- |
| Administrador de um E-commerce. | Visualizar todas as promoções e seus respectivos itens. | Seja possivel conferir todas as promoções e seus itens. |
...
| Como | Eu quero | Para que |
| ------- | ------- | ------- |
| Usuário de um E-commerce. | Poder visualizar os descontos de promoções na sacola. | Seja possível conferir os descontos e valor final. |
  
</details>

<details><summary>Story 15 - Alerta de Desconto</summary>
  
| Como | Eu quero | Para que |
| ------- | ------- | ------- |
| Usuário de um E-commerce. | Ser avisado caso os produtos da minha sacola tenham entrado em promoção. | Seja possível usufruir de todas as promoções e descontos. |
...
| Como | Eu quero | Para que |
| ------- | ------- | ------- |
| Assistente de cadastro de um E-commerce. | Filtrar as promoções ativas e interrompidas. | Seja possível visualizar quais promoções estão ativas e quais promoções foram interrompidas. |
